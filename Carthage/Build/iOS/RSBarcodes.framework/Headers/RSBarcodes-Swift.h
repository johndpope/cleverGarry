...
@property (nonatomic, strong) AVCaptureMetadataOutput * __nonnull output;
@property (nonatomic, strong) AVCaptureSession * __nonnull session;
@property (nonatomic, strong) RSFocusMarkLayer * __nonnull focusMarkLayer;
@property (nonatomic, strong) RSCornersLayer * __nonnull cornersLayer;
